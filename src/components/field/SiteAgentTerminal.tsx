  ...
  const handleCameraCapture = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setTimeout(() => {
      ...
      if (randomTruck) {
        ...
        setEstimatedTonnes(randomTruck.capacity_tonnes || randomTruck.capacity || 30);
        setDeliveredTonnes(randomTruck.capacity_tonnes || randomTruck.capacity || 30);
  ...
  const handleScanPreset = (plate: string, truckId: string, driverId: string, img: string) => {
    ...
    setTimeout(() => {
      ...
      if (trk) {
        ...
        setDeliveredTonnes(trk.capacity_tonnes || trk.capacity || 30);
      }
      setIsScanning(false);
    }, 450);
  };
